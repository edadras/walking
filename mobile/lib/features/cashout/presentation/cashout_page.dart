    ...
    return AppCard(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.baseline, textBaseline: TextBaseline.alphabetic, children: [
          Text(Fa.number(o.availablePoints), style: context.text.displaySmall),
          const SizedBox(width: AppSpacing.xs),
          Text(l.pointsUnit, style: context.text.bodyMedium?.copyWith(color: p.inkMuted)),
        ]),
        Text(Fa.rial(o.availablePoints * o.rialPerPoint), style: context.text.bodyMedium?.copyWith(color: p.goldInk, fontWeight: FontWeight.w600)),
